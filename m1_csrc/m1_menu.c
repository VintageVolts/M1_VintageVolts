...
S_M1_Menu_t menu_Settings_Swap_FW_Bank =
{
    "Swap FW Bank", settings_swap_fw_bank, NULL, NULL, 0, 0, NULL, NULL, NULL
};

S_M1_Menu_t menu_Settings =
{
    "Settings", menu_settings_init, NULL, NULL, 6, 0, menu_m1_icon_setting, NULL,
    /*{&menu_Settings_LCD_and_Notifications,*/ {&menu_Settings_Storage, &menu_Settings_Power,/* &menu_Settings_System,*/ &menu_Setting_Firmware_Update, &menu_Setting_ESP32, &menu_Settings_Swap_FW_Bank, &menu_Settings_About}
};
