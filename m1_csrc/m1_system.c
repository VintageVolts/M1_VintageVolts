...
void startup_info_screen_display(const char *scr_text)
{
	...
	sprintf(fw_ver, "Ver %d.%d.%d.%d", m1_device_stat.config.fw_version_major, m1_device_stat.config.fw_version_minor, m1_device_stat.config.fw_version_build, m1_device_stat.config.fw_version_rc);
	len = strlen(fw_ver);
